...
class InHomePageTopThree extends StatefulWidget {
  const InHomePageTopThree({super.key});

  @override
  State<InHomePageTopThree> createState() => _InHomePageTopThreeState();
}

class _InHomePageTopThreeState extends State<InHomePageTopThree> {
        ...
        child: Column(
          children: [
            Center(
              child: Column(
                children: [
                  ...
                  Text(
                    'impresses because of its realistic',
                    style: TextStyle(
                ...
                InkWell(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const InHomePageTopThree(),
                      ),
                    );
                  },
                ),
            ...
            Container(
              height: 50,
              child: Text(
                'Directed by Pete Docter, Ronnie Del Carmen. With Amy Poehler, Phyllis Smith, Richard Kind, Bill Hader. After young Riley is uprooted from her',
                maxLines: 3,
